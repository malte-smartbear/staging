 ...
 */
$app->POST('/newOrgTest/hotfixAPI/1.0.0/pet', function($request, $response, $args) {
 ...
 * Output-Formats: [application/xml, application/json]
 */
$app->DELETE('/newOrgTest/hotfixAPI/1.0.0/pet/{petId}', function($request, $response, $args) {
 ...
 * Output-Formats: [application/xml, application/json]
 */
$app->GET('/newOrgTest/hotfixAPI/1.0.0/pet/findByStatus', function($request, $response, $args) {
 ...
 * Output-Formats: [application/xml, application/json]
 */
$app->GET('/newOrgTest/hotfixAPI/1.0.0/pet/findByTags', function($request, $response, $args) {
 ...
 * Output-Formats: [application/xml, application/json]
 */
$app->GET('/newOrgTest/hotfixAPI/1.0.0/pet/{petId}', function($request, $response, $args) {
 ...
 * Output-Formats: [application/xml, application/json]
 */
$app->PUT('/newOrgTest/hotfixAPI/1.0.0/pet', function($request, $response, $args) {
 ...
 * Output-Formats: [application/xml, application/json]
 */
$app->POST('/newOrgTest/hotfixAPI/1.0.0/pet/{petId}', function($request, $response, $args) {
 ...
 */
$app->POST('/newOrgTest/hotfixAPI/1.0.0/pet/{petId}/uploadImage', function($request, $response, $args) {
 ...
 * Output-Formats: [application/xml, application/json]
 */
$app->DELETE('/newOrgTest/hotfixAPI/1.0.0/store/order/{orderId}', function($request, $response, $args) {
 ...
 * Output-Formats: [application/json]
 */
$app->GET('/newOrgTest/hotfixAPI/1.0.0/store/inventory', function($request, $response, $args) {
 ...
 * Output-Formats: [application/xml, application/json]
 */
$app->GET('/newOrgTest/hotfixAPI/1.0.0/store/order/{orderId}', function($request, $response, $args) {
 ...
 * Output-Formats: [application/xml, application/json]
 */
$app->POST('/newOrgTest/hotfixAPI/1.0.0/store/order', function($request, $response, $args) {
 ...
 * Output-Formats: [application/xml, application/json]
 */
$app->POST('/newOrgTest/hotfixAPI/1.0.0/user', function($request, $response, $args) {
 ...
 * Output-Formats: [application/xml, application/json]
 */
$app->POST('/newOrgTest/hotfixAPI/1.0.0/user/createWithArray', function($request, $response, $args) {
 ...
 * Output-Formats: [application/xml, application/json]
 */
$app->POST('/newOrgTest/hotfixAPI/1.0.0/user/createWithList', function($request, $response, $args) {
 ...
 * Output-Formats: [application/xml, application/json]
 */
$app->DELETE('/newOrgTest/hotfixAPI/1.0.0/user/{username}', function($request, $response, $args) {
 ...
 * Output-Formats: [application/xml, application/json]
 */
$app->GET('/newOrgTest/hotfixAPI/1.0.0/user/{username}', function($request, $response, $args) {
 ...
 * Output-Formats: [application/xml, application/json]
 */
$app->GET('/newOrgTest/hotfixAPI/1.0.0/user/login', function($request, $response, $args) {
 ...
 * Output-Formats: [application/xml, application/json]
 */
$app->GET('/newOrgTest/hotfixAPI/1.0.0/user/logout', function($request, $response, $args) {
 ...
 * Output-Formats: [application/xml, application/json]
 */
$app->PUT('/newOrgTest/hotfixAPI/1.0.0/user/{username}', function($request, $response, $args) {
