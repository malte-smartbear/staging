...
public class ApiClient {
    ...
    private String basePath = "https://stage-virtserver.swaggerhub.com/qatest1Org/gitHubSync/1.0.0";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://stage-virtserver.swaggerhub.com/qatest1Org/gitHubSync/1.0.0
